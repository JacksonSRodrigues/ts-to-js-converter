...
var argDefinitions = [
    { name: "source", alias: "s", type: function (src) { return path_1.default.normalize(src); } },
    { name: "output", alias: "o", type: function (out) { return path_1.default.normalize(out); } },
...
var execTSC = function (sourceFile, outDir, target, noResolve, preserveJSX) {
    ...
    if (preserveJSX === void 0) { preserveJSX = true; }
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var tscExecCode = "npx tsc " + sourceFile + " --target " + target + " --outDir " + outDir + " --noResolve " + noResolve + (preserveJSX ? " --jsx preserve" : "");
...
var getExtension = function (extension) {
    var _a;
    return (_a = lodash_1.default.find(convertedExtensions, function (conversion) {
        return lodash_1.default.isEqual(conversion.source, extension);
    })) === null || _a === void 0 ? void 0 : _a.destination;
};
var findGeneratedFilePath = function (fileInfo, generatedFolder, pathRelativeToSource) { return __awaiter(void 0, void 0, void 0, function () {
    var extension, baseName, generatedFileExtension, newFileName, possiblePaths, foundPaths;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                possiblePaths = [
                    path_1.default.join(generatedFolder, pathRelativeToSource, newFileName),
                    path_1.default.join(generatedFolder, newFileName), // created at root of destination
                ];
                return [4 /*yield*/, bluebird_1.default.filter(possiblePaths, function (path) {
...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, source, output, target, noResolve, copyNonTSFile, exclude, _tmpDir, sourceTree, flattenedFiles, results;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = command_line_args_1.default(argDefinitions), source = _a.source, output = _a.output, target = _a.target, noResolve = _a.noResolve, copyNonTSFile = _a.copyNonTSFile, exclude = _a.exclude;
            ...
            case 1:
                ...
                return [4 /*yield*/, bluebird_1.default.mapSeries(flattenedFiles, function (fileInfo) { return __awaiter(void 0, void 0, void 0, function () {
                        var sourceFolder, pathFromSource, destinationDir, isTSFile, destinationPath, error_1, extension, baseName, newFileName, destinationPath, generatedFile;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                ...
                                case 2:
                                    ...
                                    pathFromSource = path_1.default.normalize(sourceFolder.replace(source, ""));
                                    destinationDir = path_1.default.join(output, pathFromSource);
                                ...
                                case 5:
                                    ...
                                    return [4 /*yield*/, execTSC(fileInfo.path, _tmpDir, target, noResolve)];
                                case 6:
                                    _a.sent();
                                    return [3 /*break*/, 12];
                                case 7:
                                ...
                                case 8:
                                    ...
                                    destinationPath = path_1.default.join(destinationDir, newFileName);
                                    return [4 /*yield*/, findGeneratedFilePath(fileInfo, _tmpDir, pathFromSource)];
                                case 9:
                                    generatedFile = _a.sent();
                                    if (!!lodash_1.default.isEmpty(generatedFile)) return [3 /*break*/, 11];
                                    return [4 /*yield*/, fs_extra_1.default.copy(generatedFile, destinationPath)];
                                case 10:
                                    _a.sent();
                                    return [2 /*return*/, __assign(__assign({}, fileInfo), { status: "SUCCESS", generatedFile: generatedFile })];
                                case 11: return [2 /*return*/, __assign(__assign({}, fileInfo), { status: "FAILED", generatedFile: generatedFile })];
